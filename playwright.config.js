...
const PORT = 4173;
// Pages are built with a fake publish API; tests route it to the real Worker code (tests/publish-mock.js).
if (!process.env.EDOC_BASE_URL) process.env.EDOC_PUBLISH_API ||= 'https://edoc-api.test';
